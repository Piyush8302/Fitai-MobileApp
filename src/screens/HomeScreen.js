  ...
  return (
    <LinearGradient colors={COLORS.gradientDark} style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        <GradientCard colors={['#6C63FF20', '#1A1A2E']} style={styles.progressCard}>
        ...
        {/* Current Goal */}
        <GradientCard colors={['#FF6B6B15', '#1A1A2E']} style={styles.goalCard}>
        ...
        {/* Motivational Quote */}
        <GradientCard colors={['#9C27B015', '#1A1A2E']} style={styles.quoteCard}>
...
const styles = StyleSheet.create({
  ...
  quickGradient: { padding: 16, alignItems: 'center', borderRadius: SIZES.radius },
  quickIcon: {
    width: 50, height: 50, borderRadius: 25,
    alignItems: 'center', justifyContent: 'center', marginBottom: 8,
  },
  quickTitle: { fontSize: SIZES.fontSm, color: COLORS.textSecondary, ...FONTS.semiBold },
