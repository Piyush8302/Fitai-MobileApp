...
import GymFeesScreen from '../screens/GymFeesScreen';
import GymStaffDetailScreen from '../screens/GymStaffDetailScreen';
...
const AppNavigator = () => (
  <NavigationContainer ref={navigationRef} theme={DarkNavTheme}>
    <Stack.Navigator screenOptions={{ headerShown: false, animation: 'slide_from_right', contentStyle: { backgroundColor: COLORS.dark } }}>
      ...
      <Stack.Screen name="GymFees" component={GymFeesScreen} />
      <Stack.Screen name="GymStaffDetail" component={GymStaffDetailScreen} />
